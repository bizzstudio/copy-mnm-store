      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="font-serif text-xl">
            <span className="text-mainColor-dark font-bold">
        ...
        <Link
          ...
          className="text-sm font-serif font-medium px-6 py-2 bg-mainColor text-center rounded-full text-white hover:bg-mainColor-dark"
        >
          {showingTranslateValue(
