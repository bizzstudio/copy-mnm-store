  ...
  setting: {
    ...
    home: {
      ...
      quick_delivery_description: {
        en: "There are many products you will find in our shop, Choose your daily necessary product from our תמרים בתומר shop and get some special offers. See Our latest discounted products from here and get a special discount.",
        de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem תמרים בתומר-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
      },
      ...
      daily_need_title: {
        en: "Get Your Daily Needs From Our תמרים בתומר Store",
        de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
      },
      daily_need_description: {
        en: "There are many products you will find in our shop, Choose your daily necessary product from our תמרים בתומר shop and get some special offers.",
        de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem תמרים בתומר-Shop und erhalten Sie einige Sonderangebote.",
      },
    ...
    about_us: {
      ...
      top_title: {
        en: "Welcome to our תמרים בתומר shop",
        de: "Willkommen in unserem תמרים בתומר-Shop",
      },
      top_description: {
    ...
    contact_us: {
      ...
      email_box_email: {
        en: "info@תמרים בתומר.com ",
        de: "info@תמרים בתומר.com",
      },
      email_box_text: {
    ...
    faq: {
      ...
      faq_one: {
        en: "How does the תמרים בתומר work?",
        de: "Wie funktioniert der תמרים בתומר?",
      },
      description_one: {
      ...
      faq_five: {
        en: "What is תמרים בתומר EC2 auto scaling?",
        de: "Was ist die automatische Skalierung von תמרים בתומר EC2?",
      },
      description_five: {
        en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
      ...
      faq_six: {
        en: "What are the benefits of using תמרים בתומר affliate?",
    ...
    seo: {
      ...
      meta_title:
        "תמרים בתומר - React Grocery & Organic Food Store e-commerce Template",
      meta_url: "https://תמרים בתומר-store-nine.vercel.app/",
    },
  },
