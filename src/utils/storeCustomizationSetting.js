  ...
  setting: {
    ...
    home: {
      ...
      quick_delivery_description: {
        en: "There are many products you will find in our shop, Choose your daily necessary product from our BizzExpo shop and get some special offers. See Our latest discounted products from here and get a special discount.",
        de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem BizzExpo-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
      },
      ...
      daily_need_title: {
        en: "Get Your Daily Needs From Our BizzExpo Store",
        de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
      },
      daily_need_description: {
        en: "There are many products you will find in our shop, Choose your daily necessary product from our BizzExpo shop and get some special offers.",
        de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem BizzExpo-Shop und erhalten Sie einige Sonderangebote.",
      },
    ...
    about_us: {
      ...
      top_title: {
        en: "Welcome to our BizzExpo shop",
        de: "Willkommen in unserem BizzExpo-Shop",
      },
      top_description: {
    ...
    contact_us: {
      ...
      email_box_email: {
        en: "info@BizzExpo.com ",
        de: "info@BizzExpo.com",
      },
      email_box_text: {
    ...
    faq: {
      ...
      faq_one: {
        en: "How does the BizzExpo work?",
        de: "Wie funktioniert der BizzExpo?",
      },
      description_one: {
      ...
      faq_five: {
        en: "What is BizzExpo EC2 auto scaling?",
        de: "Was ist die automatische Skalierung von BizzExpo EC2?",
      },
      description_five: {
        en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
      ...
      faq_six: {
        en: "What are the benefits of using BizzExpo affliate?",
    ...
    seo: {
      ...
      meta_title:
        "BizzExpo - React Grocery & Organic Food Store e-commerce Template",
      meta_url: "https://BizzExpo-store-nine.vercel.app/",
    },
  },
