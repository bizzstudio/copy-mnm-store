  ...
  setting: {
    ...
    home: {
      ...
      quick_delivery_description: {
        en: "There are many products you will find in our shop, Choose your daily necessary product from our MNM יבוא שיווק והפצה shop and get some special offers. See Our latest discounted products from here and get a special discount.",
        de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem MNM יבוא שיווק והפצה-Shop und erhalten Sie einige Sonderangebote. Sehen Sie sich hier unsere neuesten reduzierten Produkte an und sichern Sie sich einen Sonderrabatt.",
      },
      ...
      latest_discount_description: {
        he: "מוצרים חדשים במערכת — עדכונים שוטפים למלאי.",
        en: "New products in our catalog.",
        de: "Neue Produkte in unserem Katalog.",
      },
      latest_discount_product_limit: 18,
      daily_need_title: {
        en: "Get Your Daily Needs From Our MNM יבוא שיווק והפצה Store",
        de: "Holen Sie sich Ihren täglichen Bedarf in Ihrem CloudCleaver-Shop",
      },
      daily_need_description: {
        en: "There are many products you will find in our shop, Choose your daily necessary product from our MNM יבוא שיווק והפצה shop and get some special offers.",
        de: "Es gibt viele Produkte, die Sie in unserem Shop finden. Wählen Sie Ihr täglich benötigtes Produkt aus unserem MNM יבוא שיווק והפצה-Shop und erhalten Sie einige Sonderangebote.",
      },
    ...
    about_us: {
      ...
      top_title: {
        en: "Welcome to our MNM יבוא שיווק והפצה shop",
        de: "Willkommen in unserem MNM יבוא שיווק והפצה-Shop",
      },
      top_description: {
    ...
    contact_us: {
      ...
      email_box_email: {
        en: "info@MNM יבוא שיווק והפצה.com ",
        de: "info@MNM יבוא שיווק והפצה.com",
      },
      email_box_text: {
    ...
    faq: {
      ...
      faq_one: {
        en: "How does the MNM יבוא שיווק והפצה work?",
        de: "Wie funktioniert der MNM יבוא שיווק והפצה?",
      },
      description_one: {
      ...
      faq_five: {
        en: "What is MNM יבוא שיווק והפצה EC2 auto scaling?",
        de: "Was ist die automatische Skalierung von MNM יבוא שיווק והפצה EC2?",
      },
      description_five: {
        en: "Continually impact seamless imperatives for best-of-breed best practices. Phosfluorescently facilitate parallel applications with unique imperatives. Proactively plagiarize functionalized deliverables via inexpensive solutions. Collaboratively embrace web-enabled infomediaries rather than diverse testing procedures.",
      ...
      faq_six: {
        en: "What are the benefits of using MNM יבוא שיווק והפצה affliate?",
    ...
    footer: {
      ...
      block1_sub_link1: "/עלינו",
      block1_sub_title2: {
        en: "Contact Us",
        de: "Kontaktiere uns",
      },
      block1_sub_link2: "/צרו-קשר",
      block1_sub_title3: {
        en: "Careers",
        de: "Karriere",
      },
    ...
    seo: {
      ...
      meta_title:
        "MNM יבוא שיווק והפצה - React Grocery & Organic Food Store e-commerce Template",
      meta_url: "https://MNM יבוא שיווק והפצה-store-nine.vercel.app/",
    },
  },
