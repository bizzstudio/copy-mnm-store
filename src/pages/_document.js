...
class MyDocument extends Document {
 ...
 {/* --- Google Tag Manager SCRIPT בתוך ה-HEAD --- */}
          <script
            dangerouslySetInnerHTML={{
              ...
              })(window,document,'script','dataLayer','GTM-5CFPG5F');`,
            }}
          />
...
{/* ----- BODY START SCRIPTS ----- */}
          ...
          {/* ----- NOSCRIPT (GTM) – ללא עטיפה בכלל ----- */}
          <noscript
            dangerouslySetInnerHTML={{
              __html: `
                <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5CFPG5F"
